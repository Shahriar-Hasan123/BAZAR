        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="flex flex-col">
            ...
            {/* ── ADD TO CART ── */}
            {/* Will be wired to cart store in a later lesson */}
            <div className="space-y-3 mt-auto">
              <button className="w-full py-3.5 rounded-2xl bg-blue-600 text-white font-semibold hover:bg-blue-700 active:bg-blue-800 transition-colors text-sm sm:text-base">
                Add to Cart
              </button>
